...
import { Beaker, ChevronRight, FlaskConical, Info, Menu, Plus, Settings, X } from "lucide-react";
...
function LocaleSelector() {
  ...
  return <div className="locale-switch" aria-label={locale === "ko" ? "언어 선택" : "Choose language"}>
...
function Sidebar({ pathname, recentRuns, onNavigate }: { pathname: string; recentRuns: RecentRunLink[]; onNavigate?: () => void }) {
