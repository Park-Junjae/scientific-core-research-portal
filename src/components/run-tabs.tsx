...
export function RunTabs({ slug, active }: { slug: string; active: RunTab }) {
  const { t } = useLocale();
  const tabs = [["summary/", t("summary"), "Summary"], ["ideas/", t("ideas"), "Ideas"], ["literature/", t("literature"), "Literature"], ["knowledge/", t("knowledge"), "Knowledge"], ["specification/", t("specification"), "Specification"], ["reports/", t("report"), "Reports"]] as const;
