...
Historical synthetic test fixtures were deterministically migrated with `tests/fixtures/tools/migrate-content-v2.mjs`.
...
The migration utility and its input are test fixtures only. Production contains no synthetic run routes or records.
